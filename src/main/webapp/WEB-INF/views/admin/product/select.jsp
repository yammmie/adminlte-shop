				...
				<div class="container text-center">
					...
					<form class="form-horizontal center-block">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" class="form-control" name="pro_discount" id="pro_discount" value="${productVO.pro_discount}" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 control-label">제조사</label>
							<div class="col-xs-6">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" class="form-control" name="pro_amount" id="pro_amount" value="${productVO.pro_amount}" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
					...
					<br><br>
					<form class="text-center" name="deleteForm" method="post" action="/admin/product/delete${pm.makeSearch(pm.cri.page)}">
